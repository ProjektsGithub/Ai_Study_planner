...
const StreakCounter = ({ streak = 0 }) => {
  ...
  return (
    <Card className="p-5 border border-slate-100 dark:border-white/10 bg-white dark:bg-gradient-to-br dark:from-violet-600/10 dark:to-violet-900/5 relative overflow-hidden shadow-sm">
      {/* Background Glow */}
