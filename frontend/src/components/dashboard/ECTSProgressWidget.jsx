    ...
    >
      ...
      <div>
        <div className="flex justify-between items-center mb-3">
          <span className="text-xs text-slate-400 dark:text-white/40 font-semibold uppercase tracking-wider">ECTS Progression</span>
        ...
        <div className="flex items-baseline gap-2 mb-4">
          <span className="text-3xl font-bold text-slate-800 dark:text-white leading-none">{obtained.toFixed(1)}</span>
          <span className="text-xs text-slate-400 dark:text-white/30 font-medium">/ {target.toFixed(1)} ECTS</span>
        </div>
      </div>
