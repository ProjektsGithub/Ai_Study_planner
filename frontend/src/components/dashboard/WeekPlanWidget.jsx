...
const WeekPlanWidget = () => {
  ...
  const daysList = [
    { key: 'Monday', short: t('days.short.Mon') },
    { key: 'Tuesday', short: t('days.short.Tue') },
    { key: 'Wednesday', short: t('days.short.Wed') },
    { key: 'Thursday', short: t('days.short.Thu') },
    { key: 'Friday', short: t('days.short.Fri') },
    { key: 'Saturday', short: t('days.short.Sat') },
    { key: 'Sunday', short: t('days.short.Sun') },
  ];
    ...
    >
      ...
      <div className="flex gap-1.5 justify-between">
        {daysList.map(({ key, short }) => {
          const hasSessions = sessions.some((s) => s.day === key);
          return (
            <div
              key={key}
              className={`
