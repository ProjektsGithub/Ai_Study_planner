...
class SessionCreateRequest(BaseModel):
    ...
    def validate_task_type(cls, v: str) -> str:
        """Validate task type"""
        valid_types = [
            "lecture_review", "exercise_practice", "exam_preparation", "project_work", "reading",
            # Legacy short values (generated by AI or old frontend)
            "lecture", "exercise", "revision", "project", "practice",
        ]
